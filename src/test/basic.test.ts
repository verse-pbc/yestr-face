...
describe('Validation Utils', () => {
  ...
  it('should reject invalid pubkey', () => {
    ...
    expect(validatePubkey('e0f6050d930a61323bac4a5b47d58e961da2919834f3f58f3b312c2918852b5')).toBe(false); // too short
    expect(validatePubkey('e0f6050d930a61323bac4a5b47d58e961da2919834f3f58f3b312c2918852b55a')).toBe(false); // too long
    expect(validatePubkey('g0f6050d930a61323bac4a5b47d58e961da2919834f3f58f3b312c2918852b55')).toBe(false); // invalid char
  });
  
  it('should parse avatar request correctly', () => {
    const request = new Request('https://example.com/avatar/e0f6050d930a61323bac4a5b47d58e961da2919834f3f58f3b312c2918852b55?size=400&format=webp');
